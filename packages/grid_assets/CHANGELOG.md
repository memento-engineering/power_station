...
Backport of #310 (pow-x8xp) onto the 0.6.0 line, so a station on the promoted 0.6 core runs the bounded decision lens. The code is #310 unchanged; nothing else from the 0.7 line is carried.
