...
/// linkage + bounded-output verification (`dart verify`: one JSON line when it
/// passes, the whole transcript when it fails) + the exported [DartCommand]
/// (the CLI-SDK model: a domain asset offers domain components AND CLI
/// components; a station runner just `..addCommand(DartCommand())`).
///
